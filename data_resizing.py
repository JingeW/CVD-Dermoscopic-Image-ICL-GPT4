...
if __name__ == "__main__":
    ...
    parser.add_argument('--source_dir', type=str, default='./data/all', help='Source directory of images.')
    parser.add_argument('--target_dir', type=str, default='./data/all_resized', help='Target directory for resized images.')
