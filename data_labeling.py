...
if __name__ == "__main__":
    ...
    parser.add_argument('--source_dir', type=str, default='./data/bn_resized', help='Source directory of images.')
    parser.add_argument('--target_dir', type=str, default='./data/bn_resized_label', help='Target directory for labeled images.')
    parser.add_argument('--label', type=str, default='Benign', help='Label to add to images.')
